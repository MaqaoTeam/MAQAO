...
function XLSX:_create_pie_chart (rootpath, idx, sheet, graph)
   ...
   file:write ("<c:chartSpace xmlns:c=\"http://schemas.openxmlformats.org/drawingml/2006/chart\""
   ...
   file:write ("      <c:layout/>\n")
   file:write ("      <c:pieChart>\n")
   file:write ("        <c:varyColors val=\"1\"/>\n")
   ...
   if tab[XLSX.consts.table.orientation] == XLSX.consts.table.orientations.columns then
      for i = 2, nb_cols do
         ...
         for j = 1, nb_lines do
            file:write ("         <c:dPt>\n")
            file:write ("           <c:idx val=\""..(j - 1).."\"/>\n")
            file:write ("           <c:bubble3D val=\"0\"/>\n")
            file:write ("          <c:spPr>\n")
            file:write ("            <a:solidFill>\n")
            if graph[XLSX.consts.graph.custom_colors][j] == nil then
               file:write ("              <a:srgbClr val=\""..XLSX.consts.graph.colors[((j - 1) % (table.getn (XLSX.consts.graph.colors))) + 1].."\"/>\n")
            else
               file:write ("              <a:srgbClr val=\""..graph[XLSX.consts.graph.custom_colors][j].."\"/>\n")
            end
            file:write ("            </a:solidFill>\n")
            file:write ("            <a:ln>\n")
            file:write ("              <a:solidFill>\n")
         ...
         file:write ("                       <a:lumMod val=\"75000\"/>\n")
         file:write ("                       <a:lumOff val=\"25000\"/>\n")
         ...
         file:write ("                 </a:defRPr>\n")
         file:write ("               </a:pPr>\n")
         file:write ("               <a:endParaRPr lang=\"en-US\"/>\n")
         file:write ("             </a:p>\n")
         file:write ("           </c:txPr>\n")
         file:write ("           <c:dLblPos val=\"bestFit\"/>\n")
         file:write ("           <c:showLegendKey val=\"0\"/>\n")
         file:write ("           <c:showVal val=\"0\"/>\n")   -- Do not show values on the chart
         ...
         file:write ("           <c:showLeaderLines val=\"1\"/>\n")
         file:write ("           <c:leaderLines>\n")
         file:write ("             <c:spPr>\n")
         file:write ("               <a:ln w=\"9525\" cap=\"flat\" cmpd=\"sng\" algn=\"ctr\">\n")
         file:write ("                 <a:solidFill>\n")
         file:write ("                   <a:schemeClr val=\"tx1\">\n")
         file:write ("                     <a:lumMod val=\"35000\"/>\n")
         file:write ("                     <a:lumOff val=\"65000\"/>\n")
         file:write ("                   </a:schemeClr>\n")
         file:write ("                 </a:solidFill>\n")
         file:write ("                 <a:round/>\n")
         file:write ("               </a:ln>\n")
   ...
   elseif tab[XLSX.consts.table.orientation] == XLSX.consts.table.orientations.lines then     
      for i = 1, nb_lines do
         ...
         for j = 2, nb_cols do
            file:write ("         <c:dPt>\n")
            file:write ("           <c:idx val=\""..(j - 2).."\"/>\n")
            file:write ("           <c:bubble3D val=\"0\"/>\n")
            file:write ("          <c:spPr>\n")
            file:write ("            <a:solidFill>\n")
            if graph[XLSX.consts.graph.custom_colors][j - 1] == nil then
               file:write ("              <a:srgbClr val=\""..XLSX.consts.graph.colors[((j - 2) % (table.getn (XLSX.consts.graph.colors))) + 1].."\"/>\n")
            else
               file:write ("              <a:srgbClr val=\""..graph[XLSX.consts.graph.custom_colors][j - 1].."\"/>\n")
            end
            file:write ("            </a:solidFill>\n")
            file:write ("            <a:ln>\n")
            file:write ("              <a:solidFill>\n")
   ...
   file:write ("          <c:showLeaderLines val=\"1\"/>\n")
   file:write ("        </c:dLbls>\n")
   file:write ("        <c:firstSliceAng val=\"0\"/>\n")
   file:write ("      </c:pieChart>\n")
   ...
   file:write ("  <c:spPr>\n")
   file:write ("            <a:solidFill>\n")
   file:write ("            <a:schemeClr val=\"bg1\"/>\n")
   file:write ("            </a:solidFill>\n")
   file:write ("            <a:ln w=\"9525\" cap=\"flat\" cmpd=\"sng\" algn=\"ctr\">\n")
   file:write ("            <a:solidFill>\n")
   file:write ("            <a:schemeClr val=\"tx1\">\n")
