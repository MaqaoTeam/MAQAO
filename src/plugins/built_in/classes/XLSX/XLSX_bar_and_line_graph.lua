...
function XLSX:_create_bar_and_line_chart (rootpath, idx, sheet, graph)
   ...
   local idx         = 0
   local is_sec_axis = false
   
   -- Check if secondary axis is used for bar charts
   if tab[XLSX.consts.table.orientation] == XLSX.consts.table.orientations.cols then
      for i = 2, nb_cols do
         if graph.secondary[i] == true then
            is_sec_axis = true
         end
      end
   ...
   -- Display bar charts on primary axis
   file:write ("         <c:barChart>\n")
   file:write ("           <c:barDir val=\"col\"/>\n")
   if graph[XLSX.consts.graph.grouped] == true then
      file:write ("           <c:grouping val=\"stacked\"/>\n")
   else
   ...
   if tab[XLSX.consts.table.orientation] == XLSX.consts.table.orientations.columns then   
      for i = 2, nb_cols do
         if  graph[XLSX.consts.graph.secondary][i] == nil 
         and graph[XLSX.consts.graph.lines_ser][i] == nil then
            -- For each bar chart
            file:write ("           <c:ser>\n")
            file:write ("             <c:idx val=\""..idx.."\"/>\n") 
            file:write ("             <c:order val=\""..idx.."\"/>\n")
            idx = idx + 1
            file:write ("             <c:tx>\n")
            file:write ("               <c:strRef>\n")
            file:write ("                 <c:f>Feuil1!$A$3</c:f>\n")    -- UPDATE
            ...
            file:write ("             </c:spPr>\n")
            file:write ("             <c:txPr>\n")
            file:write ("               <a:bodyPr rot=\"0\" spcFirstLastPara=\"1\" vertOverflow=\"ellipsis\" vert=\"horz\" wrap=\"square\" lIns=\"38100\" tIns=\"19050\" rIns=\"38100\" bIns=\"19050\" anchor=\"ctr\" anchorCtr=\"1\">\n")
            file:write ("                 <a:spAutoFit/>\n")
            file:write ("               </a:bodyPr>\n")
            file:write ("               <a:lstStyle/>\n")
            file:write ("               <a:p>\n")
            file:write ("                 <a:pPr>\n")
            ...
            file:write ("             <c:showLeaderLines val=\"0\"/>\n")
            file:write ("           </c:dLbls>\n")
            file:write ("           <c:cat>\n")
            file:write ("             <c:strRef>\n")
            file:write ("               <c:f>Feuil1!$B$2:$I$2</c:f>\n")   -- UPDATE
            file:write ("               <c:strCache>\n")
            file:write ("                 <c:ptCount val=\"8\"/>\n")  -- UPDATE  ------------
            file:write ("                 <c:pt idx=\"0\">\n")                             --
            file:write ("                   <c:v>> 8%</c:v>\n")                          --
            file:write ("                 </c:pt>\n")                                    --
            file:write ("                 <c:pt idx=\"1\">\n")                             --
            file:write ("                   <c:v>4% to 8%</c:v>\n")                      --
            file:write ("                 </c:pt>\n")                                    --
            file:write ("               </c:strCache>\n")                                --
            file:write ("             </c:strRef>\n")                                    --
            file:write ("           </c:cat>\n")                                         --
            file:write ("           <c:val>\n")                                          --
            file:write ("             <c:numRef>\n")                                     --
            file:write ("               <c:f>Feuil1!$B$3:$I$3</c:f>\n")                  --
            file:write ("               <c:numCache>\n")                                 --
            file:write ("                 <c:formatCode>General</c:formatCode>\n")       --
            file:write ("                 <c:ptCount val=\"8\"/>\n")                       --
            file:write ("                 <c:pt idx=\"0\">\n")                             --
            file:write ("                   <c:v>10</c:v>\n")                            --
            file:write ("                 </c:pt>\n")                                    --
            file:write ("                 <c:pt idx=\"1\">\n")                             --
            file:write ("                   <c:v>20</c:v>\n")                            --
            file:write ("                 </c:pt>\n")                                    --
            file:write ("               </c:numCache>\n")  --------------------------------
            file:write ("             </c:numRef>\n")
            file:write ("           </c:val>\n")
            ...
            file:write ("             <a:solidFill>\n")
            if graph[XLSX.consts.graph.custom_colors][i - 1] == nil then
               file:write ("               <a:srgbClr val=\""..XLSX.consts.graph.colors[((i - 2) % (table.getn (XLSX.consts.graph.colors))) + 1].."\"/>\n") -- UPDATE take the same i the previous real bar
            else
               file:write ("               <a:srgbClr val=\""..graph[XLSX.consts.graph.custom_colors][i - 1].."\"/>\n")
            end
            file:write ("             </a:solidFill>\n")
            ...
            file:write ("           <c:val>\n")
            file:write ("             <c:numRef>\n")
            file:write ("               <c:f>Feuil1!$B$4:$I$4</c:f>\n")  -- UPDATE
            file:write ("               <c:numCache>\n")
            file:write ("                 <c:formatCode>General</c:formatCode>\n")
            file:write ("                 <c:ptCount val=\"8\"/>\n") -- UPDATE
            file:write ("               </c:numCache>\n")
            ...
            file:write ("             <c:showBubbleSize val=\"0\"/>\n")
            file:write ("           </c:dLbls>\n")
            file:write ("           <c:gapWidth val=\"219\"/>\n")
            file:write ("           <c:overlap val=\"-100\"/>\n")
            file:write ("           <c:axId val=\"339277192\"/>\n")
            file:write ("           <c:axId val=\"339290776\"/>\n")
            file:write ("         </c:barChart>\n")
         end
      end
    elseif tab[XLSX.consts.table.orientation] == XLSX.consts.table.orientations.lines then     
      for i = 1, nb_lines do
         if  graph[XLSX.consts.graph.secondary][i] == nil 
         and graph[XLSX.consts.graph.lines_ser][i] == nil then
            if tab[XLSX.consts.table.data][i][1] ~= "" then
               -- For each bar chart
               file:write ("           <c:ser>\n")
               file:write ("             <c:idx val=\""..idx.."\"/>\n") 
               file:write ("             <c:order val=\""..idx.."\"/>\n")
               ...
               file:write ("               <c:strCache>\n")
               file:write ("                 <c:ptCount val=\""..(nb_cols - 1).."\"/>\n")
               for j = 2, nb_cols do
            ...
            -- empty serie, used as filler
            -- check if an empty serie exists
            elseif tab[XLSX.consts.table.data][i][1] == "" then
               file:write ("         <c:ser>\n")
               file:write ("           <c:idx val=\""..idx.."\"/>\n")
               file:write ("           <c:order val=\""..idx.."\"/>\n")
               idx = idx + 1
   ...
   if tab[XLSX.consts.table.orientation] == XLSX.consts.table.orientations.cols then
      for i = 2, nb_cols do
         if graph.secondary[i] == true then
            ...
            file:write ("             <c:val>\n")
            file:write ("               <c:numRef>\n")
            file:write ("                 <c:f>Feuil1!$B$5:$I$5</c:f>\n") -- UPDATE
            file:write ("                 <c:numCache>\n")
            file:write ("                   <c:formatCode>General</c:formatCode>\n")
            file:write ("                   <c:ptCount val=\"8\"/>\n") ------ UPDATE ----
            file:write ("                   <c:pt idx=\"0\">\n")                       --
            file:write ("                     <c:v>9.5</c:v>\n")                       --
            file:write ("                   </c:pt>\n")                                --
            file:write ("                   <c:pt idx=\"1\">\n")                       --
            file:write ("                     <c:v>8.57</c:v>\n")                      --
            file:write ("                   </c:pt>\n") ---------------------------------
            file:write ("                 </c:numCache>\n")
            file:write ("               </c:numRef>\n")
            file:write ("             </c:val>\n")
            ...
            file:write ("             <c:showBubbleSize val=\"0\"/>\n")
            file:write ("           </c:dLbls>\n")
            file:write ("           <c:gapWidth val=\"400\"/>\n")
            file:write ("           <c:axId val=\"338999512\"/>\n")
            file:write ("           <c:axId val=\"339291160\"/>\n")
            file:write ("         </c:barChart>\n")
         end
      end   
    elseif tab[XLSX.consts.table.orientation] == XLSX.consts.table.orientations.lines then     
   ...
   if tab[XLSX.consts.table.orientation] == XLSX.consts.table.orientations.cols then
      for i = 2, nb_cols do
         if graph.lines_ser[i] == true then
            file:write ("         <c:lineChart>\n")
            file:write ("           <c:grouping val=\"standard\"/>\n")
            file:write ("           <c:varyColors val=\"0\"/>\n")
            file:write ("           <c:ser>\n")
            file:write ("             <c:idx val=\""..idx.."\"/>\n")
            file:write ("             <c:order val=\""..idx.."\"/>\n")
            ...
            file:write ("             </c:tx>\n")
            file:write ("             <c:spPr>\n")
            file:write ("               <a:ln w=\"28575\" cap=\"rnd\">\n")
            file:write ("                 <a:solidFill>\n")
            if graph[XLSX.consts.graph.custom_colors][i - 1] == nil then
               file:write ("                   <a:srgbClr val=\""..XLSX.consts.graph.colors[((i - 2) % (table.getn (XLSX.consts.graph.colors))) + 1].."\"/>\n") -- UPDATE i
            else
            ...
            file:write ("             </c:spPr>\n")
            file:write ("             <c:marker>\n")
            file:write ("               <c:symbol val=\"circle\"/>\n")
            file:write ("               <c:size val=\"5\"/>\n")
            file:write ("               <c:spPr>\n")
            file:write ("                 <a:solidFill>\n")
            if graph[XLSX.consts.graph.custom_colors][i - 1] == nil then
               file:write ("                   <a:srgbClr val=\""..XLSX.consts.graph.colors[((i - 2) % (table.getn (XLSX.consts.graph.colors))) + 1].."\"/>\n") -- UPDATE i
            ...
            file:write ("            <c:val>\n")                                          --
            file:write ("              <c:numRef>\n")                                     --
            file:write ("                <c:f>Feuil1!$B$6:$I$6</c:f>\n")                  --
            file:write ("                <c:numCache>\n")                                 --
            file:write ("                  <c:formatCode>General</c:formatCode>\n")       --
            file:write ("                  <c:ptCount val=\"8\"/>\n")                     --
            file:write ("                  <c:pt idx=\"0\">\n")                           --
            ...
            file:write ("                  </c:pt>\n")                                    --
            file:write ("                  <c:pt idx=\"1\">\n")                           --
            file:write ("                    <c:v>18.07</c:v>\n")                         --
            file:write ("                  </c:pt>\n")   -----------------------------------
            file:write ("                </c:numCache>\n")
            file:write ("              </c:numRef>\n")
            file:write ("            </c:val>\n")
            file:write ("            <c:smooth val=\"0\"/>\n")
            file:write ("          </c:ser>\n")
            file:write ("          <c:dLbls>\n")
            file:write ("            <c:showLegendKey val=\"0\"/>\n")
            file:write ("            <c:showVal val=\"0\"/>\n")
   ...
   file:write ("             <c:tx>\n")
   file:write ("               <c:rich>\n")
   file:write ("                 <a:bodyPr rot=\"0\" spcFirstLastPara=\"1\" vertOverflow=\"ellipsis\" vert=\"horz\" wrap=\"square\" anchor=\"ctr\" anchorCtr=\"1\"/>\n")
   file:write ("                 <a:lstStyle/>\n")
   file:write ("                 <a:p>\n")
   file:write ("                   <a:pPr>\n")
   file:write ("                     <a:defRPr sz=\"1000\" b=\"0\" i=\"0\" u=\"none\" strike=\"noStrike\" kern=\"1200\" baseline=\"0\" />\n")
   file:write ("                   </a:pPr>\n")
   file:write ("                   <a:r>\n")
   file:write ("                     <a:t></a:t>\n") -- UPDATE 
   file:write ("                   </a:r>\n")
   ...
   file:write ("             </a:p>\n")
   file:write ("           </c:txPr>\n")
   file:write ("           <c:crossAx val=\"339290776\"/>\n")
   ...
   file:write ("             <c:tx>\n")
   file:write ("               <c:rich>\n")
   file:write ("                 <a:bodyPr rot=\"-5400000\" spcFirstLastPara=\"1\" vertOverflow=\"ellipsis\" vert=\"horz\" wrap=\"square\" anchor=\"ctr\" anchorCtr=\"1\"/>\n")
   file:write ("                 <a:lstStyle/>\n")
   file:write ("                 <a:p>\n")
   file:write ("                   <a:pPr>\n")
   file:write ("                     <a:defRPr sz=\"1000\" b=\"0\" i=\"0\" u=\"none\" strike=\"noStrike\" kern=\"1200\" baseline=\"0\" />\n")
   file:write ("                   </a:pPr>\n")
   file:write ("                   <a:r>\n")
   file:write ("                     <a:t>"..XLSX:escape_str (graph[XLSX.consts.graph.primary_name]).."</a:t>\n")
   file:write ("                   </a:r>\n")
   file:write ("                 </a:p>\n")
   file:write ("               </c:rich>\n")
   file:write ("             </c:tx>\n")
   ...
   file:write ("             </a:p>\n")
   file:write ("           </c:txPr>\n")
   file:write ("           <c:crossAx val=\"339277192\"/>\n")
   file:write ("           <c:crosses val=\"autoZero\"/>\n")
...
--[
   ...
   file:write ("                   </a:pPr>\n")
   file:write ("                   <a:r>\n")
   file:write ("                     <a:t>"..XLSX:escape_str (graph[XLSX.consts.graph.secondary_name]).."</a:t>\n")
   file:write ("                   </a:r>\n")
   file:write ("                 </a:p>\n")
   file:write ("               </c:rich>\n")
   file:write ("             </c:tx>\n")
   ...
   file:write ("           </c:title>\n")
   file:write ("           <c:numFmt formatCode=\"General\" sourceLinked=\"1\"/>\n")
   file:write ("           <c:majorTickMark val=\"out\"/>\n")
   file:write ("           <c:minorTickMark val=\"none\"/>\n")
   file:write ("           <c:tickLblPos val=\"nextTo\"/>\n")
   file:write ("           <c:spPr>\n")
   file:write ("             <a:noFill/>\n")
   ...
   file:write ("             </a:p>\n")
   file:write ("           </c:txPr>\n")
   file:write ("           <c:crossAx val=\"338999512\"/>\n")
   file:write ("           <c:crosses val=\"max\"/>\n")
   file:write ("           <c:crossBetween val=\"between\"/>\n")
   file:write ("         </c:valAx>\n")
   --]]
   
   -- Legend for deleted and empty serie needed for the display
   file:write ("         <c:catAx>\n")
   file:write ("           <c:axId val=\"338999512\"/>\n")
   file:write ("           <c:scaling>\n")
   file:write ("             <c:orientation val=\"minMax\"/>\n")
   file:write ("           </c:scaling>\n")
   file:write ("           <c:delete val=\"1\"/>\n")
   file:write ("           <c:axPos val=\"b\"/>\n")
   file:write ("           <c:numFmt formatCode=\"General\" sourceLinked=\"1\"/>\n")
   file:write ("           <c:majorTickMark val=\"out\"/>\n")
   file:write ("           <c:minorTickMark val=\"none\"/>\n")
   file:write ("           <c:tickLblPos val=\"nextTo\"/>\n")
   file:write ("           <c:crossAx val=\"339291160\"/>\n")
   file:write ("           <c:crosses val=\"autoZero\"/>\n")
   file:write ("           <c:auto val=\"1\"/>\n")
   file:write ("           <c:lblAlgn val=\"ctr\"/>\n")
   file:write ("           <c:lblOffset val=\"100\"/>\n")
   ...
   file:write ("    </c:plotArea>\n")
   file:write ("    <c:legend>\n")
   file:write ("      <c:legendPos val=\"b\"/>\n")
   file:write ("      <c:legendEntry>\n")
   file:write ("        <c:idx val=\"1\"/>\n")
   file:write ("        <c:delete val=\"1\"/>\n")
   file:write ("      </c:legendEntry>\n")
   file:write ("      <c:layout/>\n")
   file:write ("      <c:overlay val=\"0\"/>\n")
