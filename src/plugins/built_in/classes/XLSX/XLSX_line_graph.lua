...
function XLSX:_create_line_chart (rootpath, idx, sheet, graph)
   ...
   file:write ("        <c:smooth val=\"0\"/>\n")
   file:write ("        <c:axId val=\"239298976\"/>\n")
   file:write ("        <c:axId val=\"239297800\"/>\n")
   file:write ("      </c:lineChart>\n")
   file:write ("      <c:catAx>\n")
   file:write ("        <c:axId val=\"239298976\"/>\n")
   ...
   file:write ("          </a:p>\n")
   file:write ("        </c:txPr>\n")
   file:write ("        <c:crossAx val=\"239297800\"/>\n")
   ...
   file:write ("        <c:scaling>\n")
   file:write ("          <c:orientation val=\"minMax\"/>\n")
   if graph[XLSX.consts.graph.y_axis_min] ~= nil then
      file:write ("          <c:min val=\""..graph[XLSX.consts.graph.y_axis_min].."\"/>\n")
   end
   file:write ("        </c:scaling>\n")
   file:write ("        <c:delete val=\"0\"/>\n")
   ...
   file:write ("          </a:p>\n")
   file:write ("        </c:txPr>\n")
   file:write ("        <c:crossAx val=\"239298976\"/>\n")
   file:write ("        <c:crosses val=\"autoZero\"/>\n")
